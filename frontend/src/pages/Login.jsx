...
const Login = () => {
  ...
  const handleLogin=async (e)=>{
    ...
    try{
      ...
      console.log( error);
      setLoading(false);
      setErr(error.response.data.message); //for incorrect password
    }
  }
    ...
    <div className='w-full h-[100vh] bg-slate-200 flex items-center justify-center'>
      ...
      <form className='w-full flex flex-col gap-[20px] items-center' onSubmit={handleLogin}> 
        ...
        rounded-lg overflow-hidden shadow-gray-200 shadow-lg relative'>
            ...
            outline-none px-[20px] py-[10px] bg-white text-gray-700 text-[19px]'
...
{err && <p className='text-red-500'>{"*" + err}</p>}  {/*display error message if any*/}
        ...
        hover:shadow-inner' disabled={loading}>
          {loading?"Loading...":"Login"}  {/*adding loading state */}
        </button>
